...
if (aligned.ok) {
  ...
  // абсолютная ширина колонки не объявлена, каркас держит точные пропорции.
  check("ширина в колонках: двойная", html.includes("width:440px"));
  check("ширина в колонках: половинная", html.includes("width:110px"));
  check("ширина в колонках: неограниченная", html.includes("width:100%"));
}
