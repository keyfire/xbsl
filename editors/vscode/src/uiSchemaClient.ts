 ...
 * undefined - the designer then behaves exactly as before (Russian keys only).
 */
export function formKeyAliases(): Promise<FormKeyPairs> {
  if (!keyAliasesPromise) {
