...
const BUCKETS: Record<string, string[]> = {
  ...
  function: ["entity.name.function.xbsl"],
...
const PALETTES: Palette[] = [
  ...
  {
    label: vscode.l10n.t("Muted"),
    detail: vscode.l10n.t("Grey keywords instead of the theme's bright purple, the rest as usual"),
    colors: {
      // The keyword of a language is its most frequent token, and the default themes paint it
      // the loudest colour on the screen. Here it steps back and the NAMES stand out instead.
      keyword: { fg: "#A0A0A0" },
      storage: { fg: "#A0A0A0" },
      annotation: { fg: "#B5A96B" },
      function: { fg: "#DCDCAA" },
      string: { fg: "#CE9178" },
      escape: { fg: "#D7BA7D" },
      number: { fg: "#B5CEA8" },
