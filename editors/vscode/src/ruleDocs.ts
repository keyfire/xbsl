...
const RULE_DOCS: ReadonlyArray<{ match: (rule: string) => boolean; page: string; anchor?: string }> = [
  ...
  { match: (r) => r === "code/captured-local-write", page: "topics/lambda-expression" },
  { match: (r) => r === "code/unused-return-value", page: "stdlib/element/xbsl/Std/Annotations/Checks/CheckValueUsage_ru" },
  { match: (r) => r === "code/ambiguous-type", page: "topics/modular-development" },
  { match: (r) => r === "yaml/ambiguous-type", page: "topics/modular-development" },
  ...
  {
    match: (r) => r === "code/this-in-static-method"
      || r === "code/instance-call-from-static",
    page: STATIC,
  },
  {
    match: (r) => r === "code/local-method-cross-component"
      || r === "code/local-method-cross-module",
    page: MODULAR,
  ...
  {
    match: (r) => r === "query/named-parameter",
  ...
  {
    match: (r) => r === "yaml/missing-subsystem-usage",
    page: MODULAR,
