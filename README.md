...
**Step 2 – generate the language data.** The linter relies on tables extracted from **your**
1C:Element distribution (keywords, the stdlib type catalog, the configuration metamodel, terms,
the documentation index, the component schema); they are NOT bundled in this repository:
...
**Rules.** 161 rules in the base set, in four tiers: **A** – structure and yaml schema, **B** – text and
