...
def test_previous_version_between_builds_of_the_same_release():
    """Сборки одной версии (1.2.3+211 / 1.2.3+243) сравниваются как соседи.
    ...
    """
    available = ["1.1.0", "1.2.3+211", "1.2.3+243"]
    assert datadiff.previous_version("1.2.3+243", available) == "1.2.3+211"
    assert datadiff.previous_version("1.2.3+211", available) == "1.1.0"
...
def test_a_member_that_changed_kind_is_a_move_not_a_removal():
    ...
    dozens of them as REMOVED - a Button without its OnClick, an Edit without its OnChange -
