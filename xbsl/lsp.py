...
def _make_server() -> "LanguageServer":
    ...
    @server.feature("xbsl/formKeys")
    def _form_keys(params: object = None) -> dict:
        # The pairs of the form structure keys (`Content` -> `Содержимое`): the designer of the
        # editor parses the yaml on its own and would otherwise render an English form as an
    ...
    def _add_module_method(params: object) -> dict:
        ...
        The metadata counterpart of xbsl/addHandler. A metadata handler (Обработчик of an
