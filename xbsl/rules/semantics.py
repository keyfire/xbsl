...
– this rules out false positives.
...
there objects supplied by external libraries would make the check guess. Deeper segments (`НаборЗаписей.Данные`, nested report parameters) are not
checked.
"""
