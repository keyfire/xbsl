...
членов.
При наличии свежих данных обобщенных типов учитываются более широкие аргументы
базы только для чтения и подстановка вложенных формул. Изменяемые параметры остаются
инвариантными; без новых данных сохраняется сравнение точных аргументов.
