...
![Расширение VS Code, движок xbsl и проект: редактор говорит с долгоживущим сервером xbsl-lsp (диагностики, дерево метаданных, предпросмотр формы, панель документации), а без сервера те же проверки идут через CLI; движок читает пары yaml/xbsl проекта и учитывает базлайн](https://raw.githubusercontent.com/keyfire/xbsl/main/editors/vscode/images/how-it-works.ru.svg)
