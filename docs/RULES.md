...
column kinds are judged. The column comes out wider than asked and the content drifts away from
its neighbour. A pixel width needs `HorizontalStretch: False`, and a share with a guaranteed
