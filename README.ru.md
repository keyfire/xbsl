...
```sh
xbsllint e1c/app --enable style --write-baseline baseline.json   # заморозить долг один раз
xbsllint e1c/app --enable style --baseline baseline.json         # всплывает только НОВОЕ
```
...
[расширения VS Code](https://github.com/keyfire/xbsl-lint/blob/main/editors/vscode/README.ru.md#исключение-находки-базлайн) (или правка
