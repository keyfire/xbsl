...
Вид элемента, вид секции и имена пишутся на языке разработки проекта: платформа документирует
словарь метаданных именно так, и инструмент принимает ровно эти написания. Перечень видов, которые
можно создать, – `xbsl new-object --help`.
